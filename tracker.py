...
# 修改：接收 cfg 对象
def update_motion_status(img_filename, longedge, single_mask, motion_dict, object_id, centroid, motion_front_center, current_time, angle, long_side_length, affine_matrix, cfg):
