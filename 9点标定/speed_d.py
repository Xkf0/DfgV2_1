...
def calculate_unit_vector(start_point1, end_point1, start_point2, end_point2):
    """
    计算从起点到终点的单位向量（x、y分量）
    start_point/end_point格式: (x, y)
    返回: (unit_x, unit_y)，分量平方和=1
    """
    start_point = (start_point2[0]-start_point1[0], start_point2[1]-start_point1[1])
    end_point = (end_point2[0]-end_point1[0], end_point2[1]-end_point1[1])

    start_point = (165.679, 200.463)
    end_point = (969.186, 204.625)
...
if __name__ == "__main__":
    ...
    line2_start = (220.568, 208.208)
    line2_end = (1013.847, 212.796)

    line2_unit_x, line2_unit_y = calculate_unit_vector(line1_start, line1_end, line2_start, line2_end)
